                    ...
                    <form className='form' style={{}}>
                        ...
                        <div style={{position:'relative',padding:'.5em 0'}}>
                            ...
                            <div style={{display:'flex',alignItems:'center',width:'100%'}}>
                                <div style={{display:'flex',alignItems:'center',justifyContent:'center',background:'#EBEBEB',padding:'0 .5em',height:'3.1em',border:'1px #DADADA solid',width:mobileCheck ? '20%':'12%',borderRight:'none',borderTopLeftRadius:'.4em',borderBottomLeftRadius:'.4em'}}>
                                    <div><p>IN</p></div>
                                    <div><p>+91</p></div>
                                </div>
                                <input style={{width:mobileCheck ? '80%':'88%',height:'2.8em',padding:'0 1em',background:'#FBFBFB',fontSize:'1.1em',fontFamily:'var(--Inter-font)',color:'#BFBFBF',border:'1px #DADADA solid',borderLeft:'none',borderTopRightRadius:'.4em',borderBottomRightRadius:'.4em',outline:'none'}} type='alphanumeric' placeholder='Mobile Number'/>
                            </div>
                        </div>
