    ...
    return(
        <footer className='footer' style={{padding:mobileCheck ? '12rem 4rem':'4rem 4rem',fontSize: mobileCheck ? '2.4rem':'1rem'}}>
            <div className='footerContainer' style={{display:'flex',flexWrap:'wrap',alignItems:'center',width:'100%'}}>
                <div style={{height:'6em',width:mobileCheck ? '40%':'33.33%',display:'flex',flexWrap:'wrap',alignItems:'center',justifyContent:'center'}}><img style={{height:'90%',width:'90%',objectFit:'contain'}} src='/heroFuturemugLogo.png' alt="" /></div>
